 ...
 *  @topic: 0
 */
function GanttProjectInfo(id, name, assigned_to, startDate)
{
    this.Id = id;
    this.Name = name;
 ...
 * @topic: 0
 */
function GanttTaskInfo(id, name, assigned_to, est, duration, percentCompleted, predecessorTaskId)
{
    this.Id = id;
    this.Name = name;
    this.assigned_to = assigned_to;
...
GanttChart.prototype.insertProject = function(id, name, startDate)
{
    ...
    var project = new GanttProjectInfo(id, name, startDate, user_id);
...
GanttTask.prototype.getPopUpInfo = function(object, event)
{
    ...
    if (typeof (this.TaskInfo.assigned_to)!="undefined")
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Assigned to:&nbsp;</span><span class='ut'>" + this.TaskInfo.assigned_to[1] + "</span><br/>";
...
GanttProject.prototype.getPopUpInfo = function(object, event)
{
    ...
    if (typeof (this.Project.Assigned_to)!="undefined")
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Assigned to:&nbsp;</span><span class='ut'>" + this.Project.Assigned_to[1] + " </span><br/>";
    // Hidden because currently misleading or unavailable:
