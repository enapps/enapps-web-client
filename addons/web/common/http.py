...
from tools import config as main_config
...
class LocalConnector(openerplib.Connector):
    ...
    def send(self, service_name, method, *args, **kwargs):
        import openerp
        import traceback
        import xmlrpclib
        code_string = "warning -- %s\n\n%s"
        try:
            return openerp.netsvc.dispatch_rpc(service_name, method, *args, **kwargs)
