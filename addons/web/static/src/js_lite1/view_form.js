...
openerp.web.FormView = openerp.web.View.extend( /** @lends openerp.web.FormView# */{
    ...
    on_button_save: function() {
        var self = this;
        if (this.widget_parent.views && this.widget_parent.views.list.controller == null) {
            this.widget_parent.views.list.controller.stop();
            this.widget_parent.views.list.controller = null;
        }
        return this.do_save()
    },
...
openerp.web.DateTimeWidget = openerp.web.OldWidget.extend({
    ...
    start: function() {
        ...
        this.picker({
            ...
            appendTo: self.widget_parent.view.$element
        });
