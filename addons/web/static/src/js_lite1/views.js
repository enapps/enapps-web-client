    ...
    _activate_tab: function () {
        ...
        this.$tab_pannel = $('#oe_app').tabs({
                activate: function(event,ui) {
                    ...
                    if (!!_inner_vm.views.calendar && _inner_vm.views.calendar.controller!=null) {
                        _calendar = self.inner_viewmanager.views.calendar.controller;
...
openerp.web.TranslateDialog = openerp.web.Dialog.extend({
    ...
    init: function(view) {
        ...
        this.view_language = view.openerp.user_context.lang;
