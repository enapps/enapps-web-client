...
openerp.web.list_editable = {};
    ...
    openerp.web.ListView.List.include(/** @lends openerp.web.ListView.List# */{
        ...
        adjust_form_view: function () {
            ...
            var self = this,
                ...
                current_row = this.dataset.index === null ? this.$current.find('.oe_fake_list_row') : this._get_current_row(this.edition_id),
            ...
            if (current_row.length > 0) {
                ...
                var left_f = self.edition_id === null
                        ? 0
        ...
        re_adjust_edition_form: function() {
            if (!!this.edition_form && this.edition_form.$element.parent('.form-cont').length>0) {
                ...
                .bind('focusout',function(e) {
                        ...
                        )
                    {
                        ...
                        $.async_when().then(function(){
                            self.silent_refresh_ed_form(e,null);
                        });
                    }
                })
        ...
        start_edition: function (row, target_field) {
            ...
            return $.when().done(function () {
                ...
                self.edition_form.forbid_focus_default = true;
                self.edition_form.do_show().then(function(){
        ...
        remove_edition_form: function() {
            ...
            if (self.edition) {
                ...
                self.edition_form.$element.html('').remove();
            ...
            if (this.edition_form) {
                ...
                if (this.complex_dirty_check()) {
                    ...
                    rend = self.ensure_saved(true).done(function(){
                        ...
                        self.start_edition(__current_row, target_field);
                        return $.Deferred().resolve();
                    });
                } else {
                    self.reload_edited_record();
                    self.has_been_saved.resolve();
                    rend = self.start_edition(__current_row, target_field).then(
                        function(){
                            return $.Deferred().resolve();
                        });
                }
    ...
    openerp.web.ListEditableFormView = openerp.web.FormView.extend({
        ...
        start: function() {
            this._super();
            this.dataset.parent_view.default_focus_field = null;
        },
