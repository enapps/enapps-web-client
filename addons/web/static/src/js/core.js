...
openerp.web.Connection = openerp.web.CallbackEnabled.extend( /** @lends openerp.web.Connection# */{
    ...
    init: function() {
        ...
        this.rpc_function = this.rpc_json;
    },
    ...
    rpc: function(url, params, success_callback, error_callback) {
        ...
        var request = this.rpc_function(url, payload);
        request.then(
            function (response, textStatus, jqXHR) {
                self.on_rpc_response();
                if (!response.error) {
                    deferred.resolve(response["result"], textStatus, jqXHR);
                    // if (typeof(self.window_pos)!=='undefined' && self.window_pos) window.scrollTo(0,self.window_pos);
    ...
    session_reload: function () {
        ...
        return this.rpc("/web/session/get_session_info", {}).then(function(result) {
            ...
            _.extend(self, {
                ...
                domain_level_db_name: result.domain_level_db_name,
                domain_level_user_name: result.domain_level_user_name,
                uid: result.uid,
        ...
        return this.rpc('/web/session/modules', {}).then(function(result) {
            ...
            if (to_load.length) {
                loaded = $.when(
                    ...
                    self.rpc('/web/webclient/translations', params).then(function(trans) {
                        openerp.web._t.database.set_bundle(trans);
                        var file_list = ["/web/static/lib/datejs/globalization/" + lang.replace("_", "-") + ".js"];
                        return self.rpc('/web/webclient/jslist', {mods: to_load}).then(function(files) {
...
openerp.web.Widget = openerp.web.CallbackEnabled.extend(/** @lends openerp.web.Widget# */{
    ...
    rpc: function(url, data, success, error) {
        ...
        var self = this;
        openerp.connection.rpc(url, data).done(function() {
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<img src="/web/static/src/img/block-loading.gif">';
}
